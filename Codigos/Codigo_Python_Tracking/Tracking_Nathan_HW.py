...
BIT_PATH = "/root/jupyter_notebooks/Tracking_Nathan_32_2/hog.bit"

# ============================================================
# 2) HOG/HW CONFIG tem que seguir hogpack
# ============================================================
ROI_SIZE = 32
PADDING  = 1

# ============================================================
# 3) CONFIGS POR SCENE E POR ALGORITMO 
# ============================================================
CONFIG = {
    "scene1": {
        "PSO": {"pop": 25, "iters": 5, "search_r": 12, "Vmax": 4.0, "wMax": 0.9, "wMin": 0.2, "c1": 2.05, "c2": 2.05},
        "GWO": {"pop": 25, "iters": 5, "search_r": 12},
    },
    "scene2": {
        "PSO": {"pop": 30, "iters": 5, "search_r": 17, "Vmax": 4.0, "wMax": 0.9, "wMin": 0.2, "c1": 2.05, "c2": 2.05},
        "GWO": {"pop": 30, "iters": 5, "search_r": 17},
    }
}
