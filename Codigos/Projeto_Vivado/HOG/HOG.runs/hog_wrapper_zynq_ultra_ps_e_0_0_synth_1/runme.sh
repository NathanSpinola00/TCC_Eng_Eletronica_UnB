...
HD_PWD='D:/TCC/NathanZeidan/NathanSZeidan_TCC/HOG/HOG.runs/hog_wrapper_zynq_ultra_ps_e_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hog_wrapper_zynq_ultra_ps_e_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hog_wrapper_zynq_ultra_ps_e_0_0.tcl
