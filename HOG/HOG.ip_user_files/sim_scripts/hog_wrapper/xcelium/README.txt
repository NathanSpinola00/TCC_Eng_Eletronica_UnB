...
#
# Generated by export_simulation on Thu Jan 15 16:13:23 -0300 2026
#
################################################################################
...
'-reset_run' switch to the './hog_wrapper.sh' script.

./hog_wrapper.sh -reset_run
...
./hog_wrapper.sh -noclean_files

For more information on the script, please type './hog_wrapper.sh -help'.
