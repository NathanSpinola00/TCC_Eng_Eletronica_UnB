...
HD_PWD='D:/TCC/NathanZeidan/NathanSZeidan_TCC/HOG/HOG.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hog_wrapper_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hog_wrapper_wrapper.tcl
