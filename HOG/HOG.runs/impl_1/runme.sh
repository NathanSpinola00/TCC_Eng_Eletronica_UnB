...
HD_PWD='D:/TCC/NathanZeidan/NathanSZeidan_TCC/HOG/HOG.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hog_wrapper_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hog_wrapper_wrapper.tcl -notrace
