...
HD_PWD='D:/TCC/NathanZeidan/NathanSZeidan_TCC/HOG/HOG.runs/hog_wrapper_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hog_wrapper_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hog_wrapper_xbar_0.tcl
